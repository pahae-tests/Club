...
export default function AdminMembres({ isDark }) {
  ...
  const [membres, setMembres] = useState([
    { id: 1, nom: "Lamrissi", prenom: "Pahae", tel: "0700000000", email: "cc@hh.com", dateN: "2000-01-15", ville: "Settat", points: 17, admin: true, img: "/imgs/sara.jpg" },
    { id: 2, nom: "Yakine", prenom: "Cho3ayp", tel: "0700000000", email: "cc@hh.com", dateN: "1999-05-20", ville: "Casablanca", points: 14, admin: false, img: "/imgs/omar.jpg" },
    { id: 3, nom: "Akotsht7", prenom: "Aicha", tel: "0700000000", email: "cc@hh.com", dateN: "1998-11-10", ville: "Rabat", points: 16, admin: true, img: "/imgs/yasmine.jpg" },
    { id: 4, nom: "Sitd", prenom: "Mehdi", tel: "0700000000", email: "cc@hh.com", dateN: "2001-03-25", ville: "Marrakech", points: 13, admin: false, img: "/imgs/amine.jpg" },
    { id: 5, nom: "Gana", prenom: "Anas", tel: "0700000000", email: "cc@hh.com", dateN: "1997-07-30", ville: "Fès", points: 12, admin: false, img: "/imgs/karim.jpg" },
    { id: 6, nom: "Lmaidar", prenom: "Youssef", tel: "0700000000", email: "cc@hh.com", dateN: "2000-09-12", ville: "Tanger", points: 11, admin: false, img: "/imgs/nadia.jpg" },
    { id: 7, nom: "Ezzati", prenom: "Mohammed", tel: "0700000000", email: "cc@hh.com", dateN: "1999-12-05", ville: "Agadir", points: 9, admin: false, img: "/imgs/mehdi.jpg" },
  ]);
  ...
  const handleSaveMembre = () => {
    ...
    if (editingMembre) {
      setMembres(membres.map(m => m.id === editingMembre ? { ...formData, id: editingMembre } : m));
    } else {
        ...
        <div className="max-w-6xl mx-auto">
          <div className={`rounded-3xl overflow-hidden backdrop-blur-xl ${
            ...
            <div className={`px-6 py-5 flex justify-between items-center border-b ${
              isDark ? 'bg-gradient-to-r from-purple-900/30 to-cyan-900/30 border-white/10' : 'bg-gradient-to-r from-purple-100/50 to-cyan-100/50 border-gray-200'
            }`}>
            ...
            <div className="divide-y divide-white/5">
              {sortedMembres.map((membre, index) => {
                ...
                return (
                  <div key={membre.id} className="p-6" style={{ animation: `fadeIn 0.5s ease-out ${index * 0.1}s both` }}>
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                      <div className="flex-1 flex items-center gap-4">
                        <div className="relative">
                          <div className={`w-12 h-12 rounded-full overflow-hidden ring-2 ${
                            membre.admin ? 'ring-purple-400' : isDark ? 'ring-gray-600' : 'ring-gray-300'
                          }`}>
                            {membre.img ? (
                              <img
                                src={membre.img}
      ...
      {showAddModal && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className={`rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto ${
            ...
            <div className="p-6 space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2 rounded-lg ${
                      isDark ? 'bg-gray-800 text-white border-gray-700' : 'bg-gray-100 text-gray-900 border-gray-300'
              ...
              <div>
                ...
                <div
                  ...
                  className={`w-full h-32 flex flex-col items-center justify-center rounded-lg border-2 border-dashed cursor-pointer ${
            ...
            <div className={`sticky bottom-0 px-6 py-4 border-t flex justify-end gap-2 ${
              isDark ? 'bg-gray-900 border-white/10' : 'bg-white border-gray-200'
            }`}>
              <button
